        ...
        public GIFRecorder (int imageWidth, int imageHeight, float frameDuration, Action<string> recordingCallback) {
            ...
            switch (Application.platform) {
                ...
                case RuntimePlatform.IPhonePlayer: {
                    ...
                    this.internalRecorder = new MediaRecorderiOS(nativeRecorder, imageWidth, imageHeight, readbackFormat, recordingDirectory, recordingCallback);
                    break;
                }
                case RuntimePlatform.Android: {
                    ...
                    this.internalRecorder = new MediaRecorderAndroid(nativeRecorder, imageWidth, imageHeight, recordingDirectory, recordingCallback);
                    break;
                }
                default:
