        ...
        public MP4Recorder (int videoWidth, int videoHeight, int videoFramerate, int audioSampleRate, int audioChannelCount, Action<string> recordingCallback, int videoBitrate = (int)(960 * 540 * 11.4f), int videoKeyframeInterval = 3) {
            ...
            switch (Application.platform) {
                ...
                case RuntimePlatform.IPhonePlayer: {
                    ...
                    this.internalRecorder = new MediaRecorderiOS(nativeRecorder, videoWidth, videoHeight, readbackFormat, recordingDirectory, recordingCallback);
                    break;
                }
                case RuntimePlatform.Android: {
                    ...
                    this.internalRecorder = new MediaRecorderAndroid(nativeRecorder, videoWidth, videoHeight, recordingDirectory, recordingCallback);
                    break;
                }
                default:
