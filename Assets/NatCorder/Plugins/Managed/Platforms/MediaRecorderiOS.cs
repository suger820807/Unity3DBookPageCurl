...
namespace NatCorder.Platforms {
    ...
    public sealed class MediaRecorderiOS : IMediaRecorder {
        ...
        public MediaRecorderiOS (IntPtr recorder, int width, int height, TextureFormat readbackFormat, string recordingDirectory, Action<string> callback) {
            ...
            recorder.StartRecording(recordingDirectory, OnRecording, (IntPtr)self);
        }
